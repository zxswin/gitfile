...
<table cellspacing="0">
<tr><th>编号</th><th>用户名</th><th>等级</th><th>登录次数</th><th>最近登录ip</th><th>最近登录时间ip</th><th>操作</th></tr>
...
<p class="center">[<a href="manage.php?action=add">新增加管理员</a>]</p>
<?php }?>
...
<?php if($this->_vars['add']){?>
   <form method="post">
      <table cellspacing="0" class="left">
         ...
         <tr><td>密码：<input type="submit" name="send" value="新增管理员" class="submit"/>[<a href="manage.php?action=list">返回列表</a>]</td></tr>
      </table>
   </form>
<?php }?>
...
<?php if($this->_vars['update']){?>
    <form method="post">
      <table cellspacing="0" class="left">
         ...
         <tr><td>密码：<input type="submit" name="send" value="修改管理员" class="submit"/>[<a href="manage.php?action=list">返回列表</a>]</td></tr>
      </table>
   </form>
<?php }?>
