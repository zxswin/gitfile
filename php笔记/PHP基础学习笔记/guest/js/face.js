...
fm.onsubmit=function(){
	...
	if(fm.password.value!=fm.notpassword.value){
		...
		fm.notpassword.focus();//将焦点移动至表单字段
		return false;
	};
	//密码提示与回答
