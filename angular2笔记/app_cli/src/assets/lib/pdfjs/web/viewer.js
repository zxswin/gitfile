    ...
    PDFThumbnailView.prototype = {
     ...
     _convertCanvasToImage: function PDFThumbnailView_convertCanvasToImage() {
      ...
      if (this.disableCanvasToImageConversion) {
       ...
       this.canvas.setAttribute('aria-gmts-label', ariaLabel);
      ...
      image.setAttribute('aria-gmts-label', ariaLabel);
     ...
     setPageLabel: function PDFThumbnailView_setPageLabel(label) {
      ...
      var ariaLabel = mozL10n.get('thumb_page_canvas', { page: this.pageId }, 'Thumbnail of Page {{page}}');
      if (this.image) {
       this.image.setAttribute('aria-gmts-label', ariaLabel);
    ...
    PDFPageView.prototype = {
     ...
     setPageLabel: function PDFView_setPageLabel(label) {
      ...
      if (this.pageLabel !== null) {
       this.div.setAttribute('data-page-gmts-label', this.pageLabel);
      } else {
       this.div.removeAttribute('data-page-gmts-label');
      }
     }
    };
    return PDFPageView;
